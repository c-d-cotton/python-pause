...
If you are in the directory where you wish to download python-pause i.e. if you wish to install the project at /home/files/python-pause/ and you are at /home/files/, and you have not already cloned the directory to /home/files/python-pause/, you can run the following commands to download the directory:

```
git clone https://github.com/c-d-cotton/mysubmodules.git getmysubmodules
python3 getmysubmodules/singlegitmodule.py python-pause --downloadmodule --deletegetsubmodules
```
...
If you have already downloaded projectdir to the folder /home/files/python-pause/, you can add the submodules by running the following commands from the directory /home/files/:
```
git clone https://github.com/c-d-cotton/mysubmodules.git getmysubmodules
python3 getmysubmodules/singlegitmodule.py python-pause --deletegetsubmodules
```
